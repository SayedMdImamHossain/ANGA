package com.example.anga.logsign;
...
public class Register extends AppCompatActivity {
    ...
    EditText mFullName,mEmail,mPassword,mPhone,mConfirm_password;
    Button mRegisterBtn;
    TextView mLoginBtn;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConfirm_password  = findViewById(R.id.signup_confirm_password);
        mPhone      = findViewById(R.id.signup_Mobile);
