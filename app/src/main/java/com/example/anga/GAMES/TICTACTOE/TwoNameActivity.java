...
public class TwoNameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final   Button button = findViewById(R.id.button2000);
        final ImageView imageView = findViewById(R.id.imageView4000);
        ...
        plyr1 = (TextInputEditText) findViewById(R.id.playerone101);
        ...
        plyr2 = (TextInputEditText) findViewById(R.id.playerone202);
        ...
        Button ds = findViewById(R.id.button2000);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(TwoNameActivity.this, tictactoe_MainActivity.class);
